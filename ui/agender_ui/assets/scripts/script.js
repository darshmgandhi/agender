...
$(document).ready(function() {
    ...
    const buttonRemove = `<button class="remove button end">Delete Field</button>` + `<br class="end">`;
    ...
    function getInputForAdd() {
        ...
        file = `<label>` +
            `<a href="{% url 'webcam' %}"> ${nameText} <input type="button" onclick="{% url 'webcam' %}"  title=""> </a>` +
            buttonRemove;
    }
